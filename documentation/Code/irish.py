...
file_path = "data/massive_amr_irish.jsonl"
...
model.save_pretrained("./fine_tuned_amr_t5_irish")
tokenizer.save_pretrained("./fine_tuned_amr_t5_irish")
...
model_path = "./fine_tuned_amr_t5_irish"
